...
@NamedQueries({
    ...
    @NamedQuery(name = "Paiement.findByFacture", query = "SELECT p FROM Paiement p WHERE p.facture = :facture"),
    ...
    @NamedQuery(name = "Paiement.findByCheque", query = "SELECT p FROM Paiement p WHERE p.cheque = :cheque"),
