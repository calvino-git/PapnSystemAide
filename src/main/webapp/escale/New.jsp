...
<f:view>
    <html>
        ...
        <body>
            ...
            <h1>New Escale</h1>
            <h:form>
                <h:inputHidden id="validateCreateField" validator="#{escale.validateCreate}" value="value"/>
                <h:panelGrid columns="2">
                    <h:outputText value="Escleunik:"/>
                    <h:inputText id="escleunik" value="#{escale.escale.escleunik}" title="Escleunik" required="true" requiredMessage="The escleunik field is required." />
                ...
                <br />
                <h:commandLink action="#{escale.create}" value="Create"/>
                <br />
                <br />
