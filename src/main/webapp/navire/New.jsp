...
<f:view>
    <html>
        ...
        <body>
            ...
            <h1>New Navire</h1>
            <h:form>
                <h:inputHidden id="validateCreateField" validator="#{navire.validateCreate}" value="value"/>
                <h:panelGrid columns="2">
                    <h:outputText value="Nacleunik:"/>
                    <h:inputText id="nacleunik" value="#{navire.navire.nacleunik}" title="Nacleunik" required="true" requiredMessage="The nacleunik field is required." />
                ...
                <br />
                <h:commandLink action="#{navire.create}" value="Create"/>
                <br />
                <br />
